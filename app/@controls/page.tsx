...
export default function ControlsPage() {
  const { tickerState, setPrice, updateSpeed, togglePause, addStock, removeStock } = useTickerContext();
  const { stocks, updateIntervalMs, isPaused } = tickerState;
          ...
          {currentStock && (
            <>
              <div className="flex items-center gap-4 mb-4 bg-gray-800 p-3 rounded-md border border-gray-700">
                ...
                <span className="text-lg font-bold text-blue-400">${currentStock.currentPrice.toFixed(2)}</span>
              </div>
